    ...
    <>
      {data.errorMessage !== "" ? (
        <div className="grid place-items-center">
          <h2 className="text-grey-700">ERROR | {data.errorMessage}</h2>
        </div>
      ) : (
        <PlacesLayout>
          <form method="post">
            <div className="px-2 w-full lg:px-[10vw] min-h-screen w-full flex flex-col md:flex-row items-center md:items-start justify-around md:p-4">
              <div className="shadow-lg rounded-lg min-h-[50vh] md:min-h-[60vh] w-full md:w-3/4 bg-highlights_light dark:bg-highlights_dark m-2 p-3">
                <div>
                  ...
                  <div className="flex items-center justify-center text-center m-4 p-2 rounded-md bg-highlights_light dark:bg-highlights_dark shadow-md">
                    <input type="submit" value="Update Profile" />
                  </div>
                </div>
              </div>
              <div className="flex flex-col justify-between items-center min-h-[60vh] w-full md:w-3/4 m-2 p-0">
                <div className="md:mx-2 w-full h-64 rounded-lg p-2 bg-highlights_light dark:bg-highlights_dark shadow-lg">
                  <label
                    htmlFor="username"
