  ...
  return (
   ...
   {/* #353e46 */} 
      <div className="h-[80px] bg-[#1c2541] dark:bg-[#353e46]">
        ...
        <img className="h-8 w-auto md:mr-3 rounded-md" src="https://res.cloudinary.com/ta1da-cloud/image/upload/v1671442731/seven-wonders/trouvaille1_vrghpe.png" alt="logo" />
        <a href="/">
